...
var github = (function(){
  ...
  function render(target, repos){
    ...
    for(i = 0; i < repos.length; i++) {
      fragment += '<li><a href="'+repos[i].html_url+'">'+repos[i].name+'</a><span>'+escapeHtml(repos[i].description||'')+'</span></li>';
    }
...
function Pinboard_Linkroll() {
  ...
  this.format_item = function(it) {
    ...
    if (!it.d) { return; }
    str += "<p><span data-icon='&#xe004;' aria-hidden='true'></span> <a class=\"pin-title\" href=\"" + this.cook(it.u) + "\">" + this.cook(it.d) + "</a><br>";
    if (it.n) {
...
var pinboard_user = "mikowl"; //id target for pinboard list
